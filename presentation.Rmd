...
<center>
https://jundurraga.github.io/COGS2020/#/
</center>

<center>
```{r qr_code, eval=T, echo=F, fig.cap="", fig.width=6, fig.height=2.5}
qrcode_gen('https://jundurraga.github.io/COGS2020/#/')
```
</center>
...
<center>
https://jundurraga.github.io/COGS2020/?print-pdf#/
</center>

<center>
```{r qr_code_pdf, eval=T, echo=F, fig.cap="", fig.width=6, fig.height=2.5}
qrcode_gen('https://jundurraga.github.io/COGS2020/?print-pdf#/')
```
</center>
...
<center>
<img class="fragment" data-fragment-index="0" src="./my_figures/spectrogram_arctic_a0002.png" width="80%" data-audio-src="./audio/sentences/arctic_a0002.wav" data-audio-advance=-1> 
</center>
...
<center>
![](./my_figures/Anatomy_of_the_Human_Ear.svg){width="50%"}
</center>
...
<li class ="fragment" data-fragment-index="0" data-audio-src="./audio/vocoder_ch_6_arctic_a0008.wav" data-audio-advance=-1> Example 1, 6 Channel vocoder </li>

<li class ="fragment" data-fragment-index="1" data-audio-src="./audio/original_arctic_a0008.wav" data-audio-advance=-1> Example 1, Original </li>

<li class ="fragment" data-fragment-index="2" data-audio-src="./audio/vocoder_ch_6_david.wav" data-audio-advance=-1> Example 2, 6 Channel vocoder </li>
<li class ="fragment" data-fragment-index="3" data-audio-src="./audio/original_david.wav" data-audio-advance=-1> Example 2, Original </li>
...
<div class='col'>
<center>
![](./my_figures/Luck_2005_erp.png){width="100%"}
</center>
